...
public class SplashScreenCargarMiArmario extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.splash_screen_cargar_armario);

        lottieAnimationView = findViewById(R.id.animation_view_cargar_armario);
        startCheckAnimation();
        ejecutarHandler();
    }
    ...
    private void startCheckAnimation() {
        ValueAnimator animator = ValueAnimator.ofFloat(0f,1f).setDuration(550);
